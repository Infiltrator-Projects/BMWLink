...
struct ContentView: View {
    ...
    private var aboutInfo: LinkDiagnosticAboutInfo {
        LinkDiagnosticAboutInfo(
            ...
            summary: "A C-first, open-source BMW vehicle diagnostics platform authored by Shannon Smith.",
            ...
            licenseText: "BMWLINK is free software licensed under the GNU General Public License version 3 or, at your option, any later version (GPL-3.0-or-later).\n\nSee LICENSE in the source package for the complete licence text.",
        ...
        LinkBrandHeader {
            HStack(spacing: 14) {
                ...
                VStack(alignment: .leading, spacing: 3) {
                    ...
                    Text("Standards core with BMW-specific diagnostics layered on top")
                        .font(.caption)
        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 15) {
                LinkLabeledPanel(title: "Standard responders", systemImage: "square.stack.3d.up.fill") {
                    ...
                    Text("This is the LINK-owned standard responder inventory. BMW-specific module discovery is added only when it is evidence-backed.")
                        .font(.caption)
                        .foregroundStyle(ProductTheme.secondary)
                        .fixedSize(horizontal: false, vertical: true)
                }
